...
class Transaciton_Aggregate:
    def __init__(self, customer_path, product_path, transaction_path):
...
def main ():
    sales = Transaciton_Aggregate('./sample_data/customers.csv', './sample_data/products.csv', './sample_data/transactions.csv')
